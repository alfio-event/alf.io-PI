...
sudo apt-get install --assume-yes nginx cups cups-client cups-bsd chromium-browser printer-driver-dymo unclutter wget dirmngr software-properties-common dpkg-sig
...
#wget https://download.dymo.com/dymo/Software/Download%20Drivers/Linux/Download/dymo-cups-drivers-1.4.0.tar.gz -P /tmp/
